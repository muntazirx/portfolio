...
<div className="my-6 rounded-lg border border-accent/25 bg-[color:color-mix(in_oklab,var(--accent)_7%,transparent)] p-4">
  <div className="mono mb-2 text-[0.7rem] uppercase tracking-widest text-accent">
    tl;dr
  </div>
  <span className="block text-sm leading-relaxed text-foreground/90">
    Learn Ligolo-ng before you start. Track credentials from machine 1. Don't
    treat root like the end. And if you're doing this over weekends, draw the
    damn map.
  </span>
</div>
...
Before I started, my friend [Justin](https://medium.com/@justinkt) gave me one piece of advice that saved me a lot of frustration:
