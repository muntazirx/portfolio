---
title: "Copy Fail 2: Getting Root on Ubuntu 24.04 Without a Password"
year: "2026"
readingTime: "8 min read"
imageSrc: "/blog/dirty-frag/initial-root-shell.png"
description: "My hands-on test of the public Copy Fail 2 PoC on Ubuntu 24.04, how the xfrm and ESP page cache write path reached root, and what mitigation worked in my VM."
...
I tested the public Copy Fail 2 proof of concept on a fresh Ubuntu 24.04 live server VM, and it worked.
...
Dirty Frag is the broader public research and naming being used around the same page cache write bug family. It matters here because it discusses a related RxRPC path, but that is not the path I demonstrated in the screenshots below.

There are two CVEs worth separating:
...
- [CVE-2026-43500](https://www.cve.org/CVERecord?id=CVE-2026-43500), the RxRPC page cache write issue discussed in Dirty Frag reporting. I did not test this path. At the time I am writing this, public reporting says this part is not fully patched upstream.
...
Copy Fail 2 does it through xfrm and ESP. Dirty Frag reporting also discusses RxRPC.
...
Copy Fail 2 used xfrm and ESP in my test. Dirty Frag reporting also discusses RxRPC, so the temporary mitigation I tested blocked both the demonstrated xfrm and ESP path and the related RxRPC module path:
